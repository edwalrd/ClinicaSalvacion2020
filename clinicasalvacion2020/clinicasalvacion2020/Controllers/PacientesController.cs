...
namespace clinicasalvacion2020.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,cedula,asegurados")] Pacientes pacientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,cedula,asegurados")] Pacientes pacientes)
        {
            if (ModelState.IsValid)
            {
