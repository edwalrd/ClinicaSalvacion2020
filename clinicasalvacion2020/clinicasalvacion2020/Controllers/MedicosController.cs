...
namespace clinicasalvacion2020.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,Exequatur,Especialidad")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,Exequatur,Especialidad")] Medico medico)
        {
            if (ModelState.IsValid)
            {
